...
// Mirrors the modern webview's forward (SEBAbstractModernWebView.webView(_:didCommit:)). Present on
// BOTH concrete classes deliberately: "the main window always gets the modern webview" is a
// reachability argument, and review F6/C10 refused those twice for this feature's twin defects.
