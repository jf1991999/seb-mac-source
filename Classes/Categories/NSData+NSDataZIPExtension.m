...
@implementation NSData (NSDataZIPExtension)
...
//    return [NSString stringWithCString:(char *)digestString length:2*CC_MD5_DIGEST_LENGTH];
    return [NSString stringWithCString:(char *)digestString encoding:NSUTF8StringEncoding];
}
