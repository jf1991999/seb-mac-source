...
- (NSError *_Nullable) connectToServer:(NSURL *)url withConfiguration:(NSDictionary *)sebServerConfiguration;
...
- (void) cancelQuitSessionWithRestart:(BOOL)restart completion:(void (^ _Nonnull)(BOOL))completion;
