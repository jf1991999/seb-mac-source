...
+ (NSString *)blinkeredScrub:(NSString *)s
{
    ...
    static NSDictionary<NSString *, NSString *> *subs;
    ...
    for (NSString *pat in subs) {
        ...
        if (re) [re replaceMatchesInString:out options:0 range:NSMakeRange(0, out.length) withTemplate:subs[pat]];
    }
    return out;
}
