...
static NSString __unused *SEBStartPage = @"https://blinkered.com.au/student.html";
static NSString __unused *SEBHelpPage = @"https://blinkered.com.au";
static NSString __unused *SEBSupportEmail = @"info@blinkered.com.au";
static NSString __unused *SEBWebsiteShort = @"blinkered.com.au";

static NSString __unused *SEBOrganization = @"ETH Zurich";
static NSString __unused *SEBCountry = @"CH";

static NSString __unused *SEBFullAppNameClassic = @"Blinkered";
static NSString __unused *SEBFullAppName = @"Blinkered";
static NSString __unused *SEBShortAppName = @"Blinkered";
static NSString __unused *SEBExtraShortAppName = @"Blinkered";
